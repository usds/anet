...
const reportTour = (currentUser, history) => {
  return {
    ...
    steps: [
      ...
      {
        title: "Recents",
        content: `If you've written reports in the past, your recent selections of attendees, ${taskShortLabelPlural}, locations and authorization groups will show up in the select pop-up. You can select them to quickly add them to your report.`,
        target: "#attendees",
        placement: "bottom"
      },
      {
