...
public abstract class Searcher implements ISearcher {
  ...
  protected Searcher(IReportSearcher reportSearcher, IPersonSearcher personSearcher,
      IOrganizationSearcher orgSearcher, IPositionSearcher positionSearcher,
      ITaskSearcher taskSearcher, ILocationSearcher locationSearcher, ITagSearcher tagSearcher,
      IAuthorizationGroupSearcher authorizationGroupSearcher,
      ISubscriptionSearcher subscriptionSearcher) {
    super();
